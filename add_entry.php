      ...
      <div id="blood"><h2 align="center" >Welcome to Blood Management System</h2></div> 
        ...
        <div class="header">
          <nav align="center" class="head">
            <a class="current-demo" href="add_entry.php">Add Entry</a>
            <a href="delete_rocord.php">Remove Entry</a>
            <a  href="update_record.php">Modify Entry</a>
          </nav>

          <h1 align="center">Add Student Data<span>Allows you to add data of students</span></h1>
        </div>
        ...
        <form id="ajaxform"> 
                ...
                <input type="button" value="Add Record" class="buttom"  id="sub" onclick="addRecords()" />
                <span id="status"></span> 
		...
		<script type="text/javascript" src = "add_entry.js"></script>
</body>
</html>
